...
<!DOCTYPE html>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      <a class="h1 text-light ml-4" style="text-decoration: none;" href="admin.php">Admin</a>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light collapse shadow">
        <h1 class="text-center mt-4 h2 text-warning">Tables</h1>
        ...
        <div class="sidebar-sticky pt-3 text-center">
                ...
                foreach ($arr as $key => $value) {
                    if($value != "car_img"){
                        echo '<li class="nav-item">
                              <a class="nav-link h6 text-dark" href="?TableName='.$value.'">'.ucfirst($value).'</a></li>'; // active
                    }
                }
             }
          ...
          ?>
            <li class="nav-item">
              <a class="nav-link h6 mt-4" href="index.php?page=login-register"><i class="fas fa-sign-out-alt"></i>Sign out</a>
            </li>
          </ul>
