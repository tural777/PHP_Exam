                        ...
                        <div class="col-lg-4">
                            <div class="footer-widgets_info">
                                ...
                                <div class="widget-short_desc">
                                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Perferendis fugit accusantium quae quos aperiam deleniti facilis dolorum porro nam eligendi. Enim, et? Iste quasi quas itaque, nulla doloremque excepturi quisquam.  
                                    </p>
                                </div>
                                <div class="widgets-essential_stuff">
                                    <ul>
                                        <li class="uren-address"><span>Address:</span> Bakı, Koroğlu Rəhimov, 70, Azərbaycan</li>
                                ...
                                <div class="uren-social_link">
                                    <ul>
                                        ...
                                        <li class="google-plus">
                                            <a href="https://plus.google.com/" data-toggle="tooltip" target="_blank" title="Google Plus">
                    ...
                    <div class="footer-bottom_nav">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 text-center">
                                    <p><a href="#">Copyright &copy; 2020</a></p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-xl-7 col-lg-6">
                                <div class="sp-content">
                                    ...
                                    <div class="uren-group_btn">
                                        <ul>
                                            <li><a href="?page=cart" class="add-to_cart">Cart To Cart</a></li>
                                            <li><a href="?page=cart"><i class="ion-android-favorite-outline"></i></a></li>
                                            <li><a href="?page=cart"><i class="ion-ios-shuffle-strong"></i></a></li>
                                        </ul>
                                    </div>
