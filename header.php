                                    ...
                                    <div class="uren-sidebar-catagories_area">
                                        ...
                                        <div class="uren-sidebar_categories mb-2">
                                            ...
                                            <div class="form-group row  mb-0">
                                                <div class="col-6">
                                                    <input name="price-min" class="form-control" type="number" value=""
                                                           placeholder="Min" id="min-number-input">
                                                </div>

                                                <div class="col-6">
                                                    <input name="price-max" class="form-control" type="number" value=""
                                                           placeholder="Max" id="max-number-input">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="uren-sidebar_categories mb-2">
                                            ...
                                            <div class="form-group row  mb-0">
                                                <div class="col-6">
                                                    <input name="year-min" class="form-control" type="number" value=""
                                                           placeholder="Min" id="min-number-input">
                                                </div>

                                                <div class="col-6">
                                                    <input name="year-max" class="form-control" type="number" value=""
                                                           placeholder="Max" id="max-number-input">
                                                </div>
                                            </div>
                                        </div>
