                                    ...
                                    <div class="uren-sidebar-catagories_area">
                                        ...
                                        <div class="uren-sidebar_categories mb-2">
                                            ...
                                            <div class="module-body mb-5">
                                                <div class="module-list_item">
                                                    <select class="nice-select wide">
                                                        <option selected>All</option>
                                                        <option>Model 1 <span>(13)</span></option>
                                                        <option>Model 2 <span>(11)</span></option>
                                                        <option>Model 3 <span>(33)</span></option>
                                                        <option>Model 4 <span>(22)</span></option>
                                                        <option>Model 5 <span>(16)</span></option>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="uren-sidebar_categories mb-2">
                                            ...
                                            <div class="form-group row  mb-0">
                                                <div class="col-6">
                                                    <input class="form-control" type="number" value="" placeholder="Min"
                                                        id="min-number-input">
                                                </div>

                                                <div class="col-6">
                                                    <input class="form-control" type="number" value="" placeholder="Max"
                                                        id="max-number-input">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="uren-sidebar_categories mb-2">
                                            ...
                                            <ul class="sidebar-checkbox_list mb-0">
                                                <li>

                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" style="cursor: pointer;"
                                                            class="custom-control-input" id="colorCheckBlack">
                                                        <label class="custom-control-label" style="cursor: pointer;"
                                                            for="colorCheckBlack">Black</label>
                                                    </div>
                                                ...
                                                <li>
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" style="cursor: pointer;"
                                                            class="custom-control-input" id="colorCheckWhite">
                                                        <label class="custom-control-label" style="cursor: pointer;"
                                                            for="colorCheckWhite">White</label>
                                                    </div>
                                                </li>
                                                <li>
                                                    <div class="custom-control custom-checkbox">
                                                        <input type="checkbox" style="cursor: pointer;"
                                                            class="custom-control-input" id="colorCheckRed">
                                                        <label class="custom-control-label" style="cursor: pointer;"
                                                            for="colorCheckRed">Red</label>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                    ...
                    <div class="container">
                        ...
                        <nav class="offcanvas-navigation">
                            <ul class="mobile-menu">
                                <li class="menu-item-has-children active"><a href="?page=main"><span
