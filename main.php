...
$model_id = isset($_POST["model-id"]) ? $_POST["model-id"] : "";
$price_min = isset($_POST["price-min"]) ? $_POST["price-min"] : "";
$price_max = isset($_POST["price-max"]) ? $_POST["price-max"] : "";
$year_min = isset($_POST["year-min"]) ? $_POST["year-min"] : "";
$year_max = isset($_POST["year-max"]) ? $_POST["year-max"] : "";
                ...
                <div class="main-slider slider-navigation_style-2">
                    ...
                    <div class="single-slide animation-style-01 bg-5">
                        <div class="slider-content">
                            ...
                            <h3>Wheels &amp; Tires</h3>
                            <p class="short-desc">Explore and immerse in exciting 360 content withFulldive’s all-in-one
                                virtual reality platform</p>
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="shop-product-wrap grid gridview-3 listfullwidth  row">
                    <?php
                    $id = "id";
                    $brand = "brand";
                    $price = "price";
                    ...
                    if ($cars != null) {
                        foreach ($cars as $count => $array) {
                            if ($array[$isactive] == 't') {
                                $firstImage = GetCarImgByCarId($array[$id]);

                                foreach ($firstImage as $key => $value) {
                                    $firstImageOfCar = "http://" . $_SERVER["SERVER_NAME"] . ":" . $_SERVER["SERVER_PORT"] . "/";

                                    $firstImageOfCar = $firstImageOfCar . $value[$img_path];
                                    break;
                                }
                            ...
                            <div class='product-slide_item'>
                                <div class='inner-slide'>
                                    <div class='single-product'>
                                        <div>
                                                <img class='primary-img' src='$firstImageOfCar' alt='Uren's Product Image'>
                                            <div class='sticker'>
                            ...
                            <div class="single-product">
                                ...
                                <div class="product-content">
                                    <div class="product-desc_info">
                                        ...
                                        <h6><a class="product-name" href="?page=single-product">Minus ipsam rerum</a>
                                        </h6>
                                        <div class="price-box">
                            ...
                            <div class="single-product">
                                ...
                                <div class="product-content">
                                    <div class="product-desc_info">
                                        ...
                                        <h6><a class="product-name" href="?page=single-product">Labore aliquid eos</a>
                                        </h6>
                                        <div class="price-box">
                            ...
                            <div class="single-product">
                                ...
                                <div class="product-content">
                                    <div class="product-desc_info">
                                        ...
                                        <h6><a class="product-name" href="?page=single-product">Enim nobis numquam</a>
                                        </h6>
                                        <div class="price-box">
                            ...
                            <div class="single-product">
                                ...
                                <div class="product-content">
                                    <div class="product-desc_info">
                                        ...
                                        <h6><a class="product-name" href="?page=single-product">Dolorem voluptates
                                                aut</a></h6>
                                        <div class="price-box">
